...
#define HARDWARE_PINS_H
  ...
  //                                           GPIO 1 ────┤ (JTAG MTDI, wolny)  ├──── GND
  //                          WATER_SENSOR_PIN GPIO 2 ────┤                     ├──── 3V3  (OUT)
  //                                RESET_PIN GPIO 21 ────┤                     ├──── GPIO 18  ATO_PUMP_RELAY_PIN
...
#define WATER_SENSOR_PIN 2           // Czujnik pływakowy (INPUT_PULLUP, active LOW)
...
#define BUZZER_PIN 23  // Buzzer (HIGH = ON)
